...
const filteredRows = computed(() =>
  leads.value.filter((row) =>
    String(row.customer).toLowerCase().includes(search.value.toLowerCase()),
  ),
)
  ...
  <div class="grid gap-6">
    ...
    <section class="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
      ...
      <UiCard
        tone="soft"
        title="交付视角"
        description="把组件沉淀成 package 后，业务侧只关心组合，不再关心底层样式重复劳动。"
      >
